...
export { ReactComponent as ArrowDownFilled } from './arrowDownFilled.svg'
export { ReactComponent as ArrowDownOutlined } from './arrowDownOutlined.svg'
export { ReactComponent as ArrowRight } from './arrowRight.svg'
export { ReactComponent as Chain } from './chain.svg'
export { ReactComponent as ChooseFilled } from './chooseFilled.svg'
